...
fun commissionMastercardORmaestro(monthTrasaction: Int, allMounthTrassaction: Int): String {
...
fun commissionVISAorMIR(monthTrasaction: Int, allMounthTrassaction: Int): String {
...
fun commisionVKpay(monthTrasaction: Int, allMounthTrassaction: Int): String {
